...
import com.papa2.boss.api.monitor.bo.LogMonitor;
import com.papa2.boss.cache.service.impl.MemcachedCacheServiceImpl;
import com.papa2.boss.framework.util.DateUtil;
import com.papa2.boss.framework.util.PropertiesUtil;
...
public class Logger4jExtend {
	...
	private void recordLogMonitor(Object message, LocationInfo locationInfo, String[] throwableStrRep) {
		...
		logMonitor.setCreateDate(DateUtil.getNowDatetimeStr());
